...
- 前端团队负责人规划、30+ 团队治理、业务线负责人机制、AI 开发治理闭环：读取 `.agents/skills/frontend-leadership/frontend-leader/SKILL.md`。
...
- 架构、基建、组件库、监控稳定性、AI 效能、质量治理：读取 `.agents/skills/frontend-leadership/tech-efficiency-architect/SKILL.md`。
- Skill 创建规范、目录质量校验、前端负责人文档归属整理：读取 `.agents/skills/company-public/skill-governance/SKILL.md`。
- OpenSpec/SDD 类流程、proposal、spec、tasks、归档、模型选择：读取 `.agents/skills/company-public/wf-openspec-mode/SKILL.md`。
